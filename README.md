...
**What it includes:**
- 4-page site: Home, About, Menu, Contact
- Fully responsive design (mobile, tablet, desktop)
- Custom CSS — no frameworks, built from scratch
- Sticky navigation, hero sections, contact form, menu layout

**Retrospective:** If I rebuilt this, I'd add a hamburger menu for mobile instead of a stacked nav, use CSS variables for the color palette from the start, and connect the contact form to a real service like Formspree so it actually sends messages.
...
- Split across any number of people
- Live calculation — updates as you type
- Clean dark results panel showing tip, total, and per-person cost

**Retrospective:** Built in ~1 hour as a final sprint project. I'd add a custom tip input field and an option to round up to the nearest dollar for a real-world use case.
...
*Built and deployed as part of Web Development coursework, Spring 2025.*
